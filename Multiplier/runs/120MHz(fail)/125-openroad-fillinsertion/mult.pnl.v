module mult (clk,
 ...
 sky130_fd_sc_hd__inv_2 _321_ (.A(net61),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_000_));
 sky130_fd_sc_hd__and2_1 _322_ (.A(\b_reg[0] ),
    .B(net58),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\product_reg[0] ));
 sky130_fd_sc_hd__a22oi_1 _323_ (.A1(\b_reg[0] ),
    .A2(net56),
    .B1(net44),
    .B2(net58),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_292_));
 sky130_fd_sc_hd__and3_1 _324_ (.A(net56),
    .B(net44),
    .C(\product_reg[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_293_));
 sky130_fd_sc_hd__nor2_1 _325_ (.A(_292_),
    .B(_293_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\product_reg[1] ));
 sky130_fd_sc_hd__nand2_1 _326_ (.A(net58),
    .B(\b_reg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_294_));
 sky130_fd_sc_hd__and4_1 _327_ (.A(\b_reg[0] ),
    .B(net56),
    .C(net44),
    .D(net54),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_295_));
 sky130_fd_sc_hd__a22o_1 _328_ (.A1(net56),
    .A2(net44),
    .B1(net54),
    .B2(net45),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_296_));
 sky130_fd_sc_hd__and2b_1 _329_ (.A_N(_295_),
    .B(_296_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_297_));
 sky130_fd_sc_hd__xnor2_1 _330_ (.A(_294_),
    .B(_297_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_298_));
 sky130_fd_sc_hd__nand2_1 _331_ (.A(_293_),
    .B(_298_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_299_));
 sky130_fd_sc_hd__or2_1 _332_ (.A(_293_),
    .B(_298_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_300_));
 sky130_fd_sc_hd__and2_1 _333_ (.A(_299_),
    .B(_300_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\product_reg[2] ));
 sky130_fd_sc_hd__nand2_1 _334_ (.A(net56),
    .B(\b_reg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_301_));
 sky130_fd_sc_hd__and4_1 _335_ (.A(net45),
    .B(net44),
    .C(net54),
    .D(net52),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_302_));
 sky130_fd_sc_hd__a22oi_1 _336_ (.A1(net43),
    .A2(net54),
    .B1(net52),
    .B2(\b_reg[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_303_));
 sky130_fd_sc_hd__nor2_1 _337_ (.A(_302_),
    .B(_303_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_304_));
 sky130_fd_sc_hd__xnor2_1 _338_ (.A(_301_),
    .B(_304_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_305_));
 sky130_fd_sc_hd__a31o_1 _339_ (.A1(net58),
    .A2(\b_reg[2] ),
    .A3(_296_),
    .B1(_295_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_306_));
 sky130_fd_sc_hd__and2_1 _340_ (.A(_305_),
    .B(_306_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_307_));
 sky130_fd_sc_hd__xor2_1 _341_ (.A(_305_),
    .B(_306_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_308_));
 sky130_fd_sc_hd__and3_1 _342_ (.A(net58),
    .B(net42),
    .C(_308_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_309_));
 sky130_fd_sc_hd__a21oi_1 _343_ (.A1(net58),
    .A2(net42),
    .B1(_308_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_310_));
 sky130_fd_sc_hd__or2_1 _344_ (.A(_309_),
    .B(_310_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_311_));
 sky130_fd_sc_hd__nor2_1 _345_ (.A(_299_),
    .B(_311_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_312_));
 sky130_fd_sc_hd__and2_1 _346_ (.A(_299_),
    .B(_311_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_313_));
 sky130_fd_sc_hd__nor2_1 _347_ (.A(_312_),
    .B(_313_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\product_reg[3] ));
 sky130_fd_sc_hd__a22oi_1 _348_ (.A1(net56),
    .A2(net42),
    .B1(net40),
    .B2(net58),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_314_));
 sky130_fd_sc_hd__and4_1 _349_ (.A(net58),
    .B(net56),
    .C(net42),
    .D(net40),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_315_));
 sky130_fd_sc_hd__nor2_1 _350_ (.A(_314_),
    .B(_315_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_316_));
 sky130_fd_sc_hd__nand2_1 _351_ (.A(net54),
    .B(\b_reg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_317_));
 sky130_fd_sc_hd__and4_1 _352_ (.A(net45),
    .B(net43),
    .C(net52),
    .D(net51),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_318_));
 sky130_fd_sc_hd__a22oi_2 _353_ (.A1(net44),
    .A2(net52),
    .B1(net51),
    .B2(net45),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_319_));
 sky130_fd_sc_hd__or3_1 _354_ (.A(_317_),
    .B(_318_),
    .C(_319_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_320_));
 sky130_fd_sc_hd__o21ai_1 _355_ (.A1(_318_),
    .A2(_319_),
    .B1(_317_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_032_));
 sky130_fd_sc_hd__o21bai_1 _356_ (.A1(_301_),
    .A2(_303_),
    .B1_N(_302_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_033_));
 sky130_fd_sc_hd__and3_1 _357_ (.A(_320_),
    .B(_032_),
    .C(_033_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _358_ (.A1(_320_),
    ...
    .VPWR(VPWR),
    .X(_035_));
 sky130_fd_sc_hd__nand2b_1 _359_ (.A_N(_034_),
    .B(_035_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_036_));
 sky130_fd_sc_hd__xnor2_1 _360_ (.A(_316_),
    .B(_036_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_037_));
 sky130_fd_sc_hd__o21a_1 _361_ (.A1(_307_),
    .A2(_309_),
    .B1(_037_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_038_));
 sky130_fd_sc_hd__nor3_1 _362_ (.A(_307_),
    .B(_309_),
    .C(_037_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_039_));
 sky130_fd_sc_hd__nor2_1 _363_ (.A(_038_),
    .B(_039_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_040_));
 sky130_fd_sc_hd__and2_1 _364_ (.A(_312_),
    .B(_040_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_041_));
 sky130_fd_sc_hd__nor2_1 _365_ (.A(_312_),
    .B(_040_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_042_));
 sky130_fd_sc_hd__nor2_1 _366_ (.A(_041_),
    .B(_042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\product_reg[4] ));
 sky130_fd_sc_hd__a21o_1 _367_ (.A1(_316_),
    .A2(_035_),
    .B1(_034_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_043_));
 sky130_fd_sc_hd__o21bai_1 _368_ (.A1(_317_),
    .A2(_319_),
    .B1_N(_318_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_044_));
 sky130_fd_sc_hd__nand2_1 _369_ (.A(\b_reg[2] ),
    .B(net52),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_045_));
 sky130_fd_sc_hd__and4_1 _370_ (.A(net45),
    .B(net43),
    .C(net51),
    .D(net50),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_046_));
 sky130_fd_sc_hd__a22oi_2 _371_ (.A1(net43),
    .A2(net51),
    .B1(net66),
    .B2(net45),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_047_));
 sky130_fd_sc_hd__or3_1 _372_ (.A(_045_),
    .B(_046_),
    .C(_047_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_048_));
 sky130_fd_sc_hd__o21ai_1 _373_ (.A1(_046_),
    .A2(_047_),
    .B1(_045_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_049_));
 sky130_fd_sc_hd__nand3_1 _374_ (.A(_044_),
    .B(_048_),
    .C(_049_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_050_));
 sky130_fd_sc_hd__a21o_1 _375_ (.A1(_048_),
    .A2(_049_),
    .B1(_044_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_051_));
 sky130_fd_sc_hd__and4_1 _376_ (.A(net56),
    .B(net54),
    .C(net42),
    .D(net40),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_052_));
 sky130_fd_sc_hd__nand4_1 _377_ (.A(net56),
    .B(net54),
    .C(net42),
    .D(net40),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_053_));
 sky130_fd_sc_hd__a22o_1 _378_ (.A1(net54),
    .A2(net42),
    .B1(net40),
    .B2(net56),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_054_));
 sky130_fd_sc_hd__and2_1 _379_ (.A(net58),
    .B(net38),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_055_));
 sky130_fd_sc_hd__a21oi_1 _380_ (.A1(_053_),
    .A2(_054_),
    .B1(_055_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_056_));
 sky130_fd_sc_hd__and3_1 _381_ (.A(_053_),
    .B(_054_),
    .C(_055_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_057_));
 sky130_fd_sc_hd__nor2_1 _382_ (.A(_056_),
    .B(_057_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_058_));
 sky130_fd_sc_hd__nand3_1 _383_ (.A(_050_),
    .B(_051_),
    .C(_058_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_059_));
 sky130_fd_sc_hd__a21o_1 _384_ (.A1(_050_),
    .A2(_051_),
    .B1(_058_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_060_));
 sky130_fd_sc_hd__and3_1 _385_ (.A(_043_),
    .B(_059_),
    .C(_060_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_061_));
 sky130_fd_sc_hd__a21oi_1 _386_ (.A1(_059_),
    .A2(_060_),
    .B1(_043_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_062_));
 sky130_fd_sc_hd__nor3b_2 _387_ (.A(_062_),
    .B(_061_),
    .C_N(_315_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_063_));
 sky130_fd_sc_hd__inv_2 _388_ (.A(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_064_));
 sky130_fd_sc_hd__o211a_1 _389_ (.A1(_052_),
    .A2(_057_),
    .B1(net58),
    .C1(net37),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_065_));
 sky130_fd_sc_hd__a211oi_1 _390_ (.A1(\a_reg[0] ),
    .A2(net37),
    .B1(_052_),
    .C1(_057_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_066_));
 sky130_fd_sc_hd__nor2_1 _391_ (.A(_065_),
    .B(_066_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_067_));
 sky130_fd_sc_hd__nand2_1 _392_ (.A(net57),
    .B(\b_reg[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_068_));
 sky130_fd_sc_hd__and4_1 _393_ (.A(net54),
    .B(net52),
    .C(net41),
    .D(net40),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_069_));
 sky130_fd_sc_hd__a22o_1 _394_ (.A1(net52),
    .A2(net41),
    .B1(net40),
    .B2(net54),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_070_));
 sky130_fd_sc_hd__and2b_1 _395_ (.A_N(_069_),
    .B(_070_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_071_));
 sky130_fd_sc_hd__xnor2_1 _396_ (.A(_068_),
    .B(_071_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_072_));
 sky130_fd_sc_hd__nand2_1 _397_ (.A(\b_reg[2] ),
    .B(net51),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_073_));
 sky130_fd_sc_hd__and2_1 _398_ (.A(net43),
    .B(net48),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and4_1 _399_ (.A(net45),
    ...
    .VPWR(VPWR),
    .X(_075_));
 sky130_fd_sc_hd__a22oi_2 _400_ (.A1(net45),
    .A2(net48),
    .B1(net50),
    .B2(net43),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_076_));
 sky130_fd_sc_hd__or3_1 _401_ (.A(_073_),
    .B(_075_),
    .C(_076_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_077_));
 sky130_fd_sc_hd__o21ai_1 _402_ (.A1(_075_),
    .A2(_076_),
    .B1(_073_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_078_));
 sky130_fd_sc_hd__o21bai_1 _403_ (.A1(_045_),
    .A2(_047_),
    .B1_N(_046_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_079_));
 sky130_fd_sc_hd__nand3_1 _404_ (.A(_077_),
    .B(_078_),
    .C(_079_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_080_));
 sky130_fd_sc_hd__a21o_1 _405_ (.A1(_077_),
    .A2(_078_),
    .B1(_079_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_081_));
 sky130_fd_sc_hd__nand3_1 _406_ (.A(_072_),
    .B(_080_),
    .C(_081_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_082_));
 sky130_fd_sc_hd__a21o_1 _407_ (.A1(_080_),
    .A2(_081_),
    .B1(_072_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_083_));
 sky130_fd_sc_hd__a21bo_1 _408_ (.A1(_051_),
    .A2(_058_),
    .B1_N(_050_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_084_));
 sky130_fd_sc_hd__nand3_2 _409_ (.A(_082_),
    .B(_083_),
    .C(_084_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_085_));
 sky130_fd_sc_hd__a21o_1 _410_ (.A1(_082_),
    .A2(_083_),
    .B1(_084_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_086_));
 sky130_fd_sc_hd__nand3_2 _411_ (.A(_067_),
    .B(_085_),
    .C(_086_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_087_));
 sky130_fd_sc_hd__a21o_1 _412_ (.A1(_085_),
    .A2(_086_),
    .B1(_067_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_088_));
 sky130_fd_sc_hd__o211a_1 _413_ (.A1(_061_),
    .A2(_063_),
    .B1(_087_),
    .C1(_088_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_089_));
 sky130_fd_sc_hd__a211oi_2 _414_ (.A1(_087_),
    .A2(_088_),
    .B1(_061_),
    .C1(net63),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_090_));
 sky130_fd_sc_hd__nor2_1 _415_ (.A(_089_),
    .B(_090_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_091_));
 sky130_fd_sc_hd__o21bai_1 _416_ (.A1(_061_),
    .A2(_062_),
    .B1_N(_315_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_092_));
 sky130_fd_sc_hd__nand3b_2 _417_ (.A_N(net34),
    .B(_092_),
    .C(_038_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_093_));
 sky130_fd_sc_hd__nor3_1 _418_ (.A(_089_),
    .B(_090_),
    .C(_093_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_094_));
 sky130_fd_sc_hd__o21a_1 _419_ (.A1(_089_),
    .A2(_090_),
    .B1(_093_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_095_));
 sky130_fd_sc_hd__or2_1 _420_ (.A(_094_),
    .B(_095_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_096_));
 sky130_fd_sc_hd__a21o_1 _421_ (.A1(_064_),
    .A2(_092_),
    .B1(_038_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_097_));
 sky130_fd_sc_hd__and3_1 _422_ (.A(_041_),
    .B(_093_),
    .C(_097_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_098_));
 sky130_fd_sc_hd__xnor2_1 _423_ (.A(_096_),
    .B(_098_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\product_reg[6] ));
 sky130_fd_sc_hd__a31o_1 _424_ (.A1(net57),
    .A2(net38),
    .A3(_070_),
    .B1(_069_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_099_));
 sky130_fd_sc_hd__nand2_1 _425_ (.A(net57),
    .B(net37),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_100_));
 sky130_fd_sc_hd__xnor2_1 _426_ (.A(_099_),
    .B(_100_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_101_));
 sky130_fd_sc_hd__and3_1 _427_ (.A(\a_reg[0] ),
    .B(net35),
    .C(_101_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_102_));
 sky130_fd_sc_hd__a21oi_1 _428_ (.A1(\a_reg[0] ),
    .A2(net35),
    .B1(_101_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_103_));
 sky130_fd_sc_hd__nor2_1 _429_ (.A(_102_),
    .B(_103_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_104_));
 sky130_fd_sc_hd__and4_1 _430_ (.A(net52),
    .B(net41),
    .C(net51),
    .D(net39),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_105_));
 sky130_fd_sc_hd__a22o_1 _431_ (.A1(net41),
    .A2(net51),
    .B1(net39),
    .B2(net52),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_106_));
 sky130_fd_sc_hd__and2b_1 _432_ (.A_N(_105_),
    .B(_106_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_107_));
 sky130_fd_sc_hd__nand2_1 _433_ (.A(net55),
    .B(\b_reg[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_108_));
 sky130_fd_sc_hd__xnor2_1 _434_ (.A(_107_),
    .B(_108_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_109_));
 sky130_fd_sc_hd__and2_1 _435_ (.A(\b_reg[2] ),
    .B(net64),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_110_));
 sky130_fd_sc_hd__a22o_1 _436_ (.A1(net43),
    .A2(net48),
    .B1(net46),
    .B2(net45),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_111_));
 sky130_fd_sc_hd__nand4_1 _437_ (.A(net45),
    .B(net43),
    .C(net48),
    .D(net46),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_112_));
 sky130_fd_sc_hd__nand3_1 _438_ (.A(_110_),
    .B(_111_),
    .C(_112_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_113_));
 sky130_fd_sc_hd__a21o_1 _439_ (.A1(_111_),
    .A2(_112_),
    .B1(_110_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_114_));
 sky130_fd_sc_hd__o21bai_1 _440_ (.A1(_073_),
    .A2(_076_),
    .B1_N(_075_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_115_));
 sky130_fd_sc_hd__nand3_1 _441_ (.A(_113_),
    .B(_114_),
    .C(_115_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_116_));
 sky130_fd_sc_hd__a21o_1 _442_ (.A1(_113_),
    .A2(_114_),
    .B1(_115_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_117_));
 sky130_fd_sc_hd__nand3_1 _443_ (.A(_109_),
    .B(_116_),
    .C(_117_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_118_));
 sky130_fd_sc_hd__a21o_1 _444_ (.A1(_116_),
    .A2(_117_),
    .B1(_109_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_119_));
 sky130_fd_sc_hd__a21bo_1 _445_ (.A1(_072_),
    .A2(_081_),
    .B1_N(_080_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_120_));
 sky130_fd_sc_hd__nand3_1 _446_ (.A(_118_),
    .B(_119_),
    .C(_120_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_121_));
 sky130_fd_sc_hd__a21o_1 _447_ (.A1(_118_),
    .A2(_119_),
    .B1(_120_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _448_ (.A(_104_),
    ...
    .VPWR(VPWR),
    .X(_123_));
 sky130_fd_sc_hd__a21oi_1 _449_ (.A1(_121_),
    .A2(_122_),
    .B1(_104_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_124_));
 sky130_fd_sc_hd__a211o_1 _450_ (.A1(_085_),
    .A2(_087_),
    .B1(_123_),
    .C1(_124_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_125_));
 sky130_fd_sc_hd__o211ai_2 _451_ (.A1(_123_),
    .A2(_124_),
    .B1(_085_),
    .C1(_087_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_126_));
 sky130_fd_sc_hd__nand3_1 _452_ (.A(_065_),
    .B(_125_),
    .C(_126_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_127_));
 sky130_fd_sc_hd__a21o_1 _453_ (.A1(_125_),
    .A2(_126_),
    .B1(_065_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_128_));
 sky130_fd_sc_hd__a21oi_1 _454_ (.A1(_127_),
    .A2(_128_),
    .B1(_089_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_129_));
 sky130_fd_sc_hd__a21o_1 _455_ (.A1(_127_),
    .A2(_128_),
    .B1(_089_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_130_));
 sky130_fd_sc_hd__and3_1 _456_ (.A(_089_),
    .B(_127_),
    .C(_128_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_131_));
 sky130_fd_sc_hd__nor2_1 _457_ (.A(_129_),
    .B(_131_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_132_));
 sky130_fd_sc_hd__a41o_1 _458_ (.A1(_041_),
    .A2(_091_),
    .A3(_093_),
    .A4(_097_),
    .B1(_094_),
    ...
    .VPWR(VPWR),
    .X(_133_));
 sky130_fd_sc_hd__xor2_1 _459_ (.A(_132_),
    .B(_133_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\product_reg[7] ));
 sky130_fd_sc_hd__a31o_1 _460_ (.A1(net57),
    .A2(net37),
    .A3(_099_),
    .B1(_102_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_134_));
 sky130_fd_sc_hd__a31o_1 _461_ (.A1(net55),
    .A2(\b_reg[5] ),
    .A3(_106_),
    .B1(_105_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_135_));
 sky130_fd_sc_hd__nand2_1 _462_ (.A(net55),
    .B(net37),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_136_));
 sky130_fd_sc_hd__xnor2_1 _463_ (.A(_135_),
    .B(_136_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_137_));
 sky130_fd_sc_hd__and2_1 _464_ (.A(net57),
    .B(\b_reg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_138_));
 sky130_fd_sc_hd__nor2_1 _465_ (.A(_137_),
    .B(_138_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_139_));
 sky130_fd_sc_hd__and2_1 _466_ (.A(_137_),
    .B(_138_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_140_));
 sky130_fd_sc_hd__or2_1 _467_ (.A(_139_),
    .B(_140_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_141_));
 sky130_fd_sc_hd__and4_1 _468_ (.A(net41),
    .B(net51),
    .C(net39),
    .D(net65),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_142_));
 sky130_fd_sc_hd__a22o_1 _469_ (.A1(\a_reg[4] ),
    .A2(net39),
    .B1(net50),
    .B2(net41),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_143_));
 sky130_fd_sc_hd__and2b_1 _470_ (.A_N(_142_),
    .B(_143_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_144_));
 sky130_fd_sc_hd__nand2_1 _471_ (.A(net53),
    .B(\b_reg[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_145_));
 sky130_fd_sc_hd__xnor2_1 _472_ (.A(_144_),
    .B(_145_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_146_));
 sky130_fd_sc_hd__a22oi_1 _473_ (.A1(\b_reg[2] ),
    .A2(net48),
    .B1(net46),
    .B2(net43),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_147_));
 sky130_fd_sc_hd__nand2_1 _474_ (.A(\b_reg[2] ),
    .B(net46),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_148_));
 sky130_fd_sc_hd__a31oi_2 _475_ (.A1(\b_reg[2] ),
    .A2(net46),
    .A3(_074_),
    .B1(_147_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_149_));
 sky130_fd_sc_hd__a21bo_1 _476_ (.A1(_110_),
    .A2(_111_),
    .B1_N(_112_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_150_));
 sky130_fd_sc_hd__nand2_1 _477_ (.A(_149_),
    .B(_150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_151_));
 sky130_fd_sc_hd__xor2_1 _478_ (.A(_149_),
    .B(_150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_152_));
 sky130_fd_sc_hd__xnor2_1 _479_ (.A(_146_),
    .B(_152_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_153_));
 sky130_fd_sc_hd__a21bo_1 _480_ (.A1(_109_),
    .A2(_117_),
    .B1_N(_116_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_154_));
 sky130_fd_sc_hd__nand2b_1 _481_ (.A_N(_153_),
    .B(_154_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_155_));
 sky130_fd_sc_hd__xor2_1 _482_ (.A(_153_),
    .B(_154_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_156_));
 sky130_fd_sc_hd__xor2_1 _483_ (.A(_141_),
    .B(_156_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_157_));
 sky130_fd_sc_hd__a21boi_2 _484_ (.A1(_104_),
    .A2(_122_),
    .B1_N(_121_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_158_));
 sky130_fd_sc_hd__and2b_1 _485_ (.A_N(_158_),
    .B(_157_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_159_));
 sky130_fd_sc_hd__xnor2_1 _486_ (.A(_157_),
    .B(_158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_160_));
 sky130_fd_sc_hd__xor2_1 _487_ (.A(_134_),
    .B(_160_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_161_));
 sky130_fd_sc_hd__a21bo_1 _488_ (.A1(_065_),
    .A2(_126_),
    .B1_N(_125_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_162_));
 sky130_fd_sc_hd__and2_1 _489_ (.A(_161_),
    .B(_162_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_163_));
 sky130_fd_sc_hd__or2_1 _490_ (.A(_161_),
    .B(_162_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_164_));
 sky130_fd_sc_hd__xnor2_1 _491_ (.A(_161_),
    .B(_162_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _492_ (.A1(_130_),
    ...
    .VPWR(VPWR),
    .X(_166_));
 sky130_fd_sc_hd__xnor2_1 _493_ (.A(_165_),
    .B(_166_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\product_reg[8] ));
 sky130_fd_sc_hd__a21o_1 _494_ (.A1(_134_),
    .A2(_160_),
    .B1(_159_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_167_));
 sky130_fd_sc_hd__a31o_1 _495_ (.A1(net55),
    .A2(net37),
    .A3(_135_),
    .B1(_140_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_168_));
 sky130_fd_sc_hd__a31o_1 _496_ (.A1(net53),
    .A2(net38),
    .A3(_143_),
    .B1(_142_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_169_));
 sky130_fd_sc_hd__nand2_1 _497_ (.A(net52),
    .B(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_170_));
 sky130_fd_sc_hd__xnor2_1 _498_ (.A(_169_),
    .B(_170_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_171_));
 sky130_fd_sc_hd__and2_1 _499_ (.A(net55),
    .B(\b_reg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _500_ (.A(_171_),
    ...
    .VPWR(VPWR),
    .Y(_173_));
 sky130_fd_sc_hd__and2_1 _501_ (.A(_171_),
    .B(_172_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_174_));
 sky130_fd_sc_hd__or2_1 _502_ (.A(_173_),
    .B(_174_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_175_));
 sky130_fd_sc_hd__nor2_1 _503_ (.A(_074_),
    .B(_148_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_176_));
 sky130_fd_sc_hd__nand4_1 _504_ (.A(net41),
    .B(net39),
    .C(net48),
    .D(net50),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_177_));
 sky130_fd_sc_hd__a22o_1 _505_ (.A1(net41),
    .A2(net48),
    .B1(net50),
    .B2(net39),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_178_));
 sky130_fd_sc_hd__nand2_1 _506_ (.A(_177_),
    .B(_178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_179_));
 sky130_fd_sc_hd__and2_1 _507_ (.A(net51),
    .B(net38),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_180_));
 sky130_fd_sc_hd__xnor2_1 _508_ (.A(_179_),
    .B(_180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_181_));
 sky130_fd_sc_hd__xnor2_1 _509_ (.A(_176_),
    .B(_181_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_182_));
 sky130_fd_sc_hd__a21boi_1 _510_ (.A1(_146_),
    .A2(_152_),
    .B1_N(_151_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_183_));
 sky130_fd_sc_hd__xnor2_1 _511_ (.A(_182_),
    .B(_183_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_184_));
 sky130_fd_sc_hd__xor2_1 _512_ (.A(_175_),
    .B(_184_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_185_));
 sky130_fd_sc_hd__o21a_1 _513_ (.A1(_141_),
    .A2(_156_),
    .B1(_155_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_186_));
 sky130_fd_sc_hd__nand2b_1 _514_ (.A_N(_186_),
    .B(_185_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_187_));
 sky130_fd_sc_hd__xnor2_1 _515_ (.A(_185_),
    .B(_186_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_188_));
 sky130_fd_sc_hd__nand2_1 _516_ (.A(_168_),
    .B(_188_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_189_));
 sky130_fd_sc_hd__xor2_1 _517_ (.A(_168_),
    .B(_188_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_190_));
 sky130_fd_sc_hd__or2_4 _518_ (.A(_167_),
    .B(_190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_191_));
 sky130_fd_sc_hd__inv_2 _519_ (.A(_191_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_192_));
 sky130_fd_sc_hd__and2_1 _520_ (.A(_167_),
    .B(_190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_193_));
 sky130_fd_sc_hd__nor2_1 _521_ (.A(_192_),
    .B(_193_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_194_));
 sky130_fd_sc_hd__a21o_1 _522_ (.A1(_164_),
    .A2(_166_),
    .B1(_163_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_195_));
 sky130_fd_sc_hd__xor2_1 _523_ (.A(_194_),
    .B(_195_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\product_reg[9] ));
 sky130_fd_sc_hd__a31o_1 _524_ (.A1(net53),
    .A2(net36),
    .A3(_169_),
    .B1(_174_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_196_));
 sky130_fd_sc_hd__a21bo_1 _525_ (.A1(_178_),
    .A2(_180_),
    .B1_N(_177_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_197_));
 sky130_fd_sc_hd__and2_1 _526_ (.A(net51),
    .B(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _527_ (.A(_197_),
    ...
    .VPWR(VPWR),
    .Y(_199_));
 sky130_fd_sc_hd__and2_1 _528_ (.A(_197_),
    .B(_198_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_200_));
 sky130_fd_sc_hd__nor2_1 _529_ (.A(_199_),
    .B(_200_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_201_));
 sky130_fd_sc_hd__nand2_1 _530_ (.A(net53),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_202_));
 sky130_fd_sc_hd__xor2_1 _531_ (.A(_201_),
    .B(_202_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and4_1 _532_ (.A(net41),
    ...
    .VPWR(VPWR),
    .X(_204_));
 sky130_fd_sc_hd__a22o_1 _533_ (.A1(net39),
    .A2(net48),
    .B1(net46),
    .B2(net41),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_205_));
 sky130_fd_sc_hd__nand2b_1 _534_ (.A_N(_204_),
    .B(_205_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_206_));
 sky130_fd_sc_hd__nand2_1 _535_ (.A(net50),
    .B(net38),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_207_));
 sky130_fd_sc_hd__xor2_1 _536_ (.A(_206_),
    .B(_207_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21bai_1 _537_ (.A1(_074_),
    ...
    .VPWR(VPWR),
    .Y(_209_));
 sky130_fd_sc_hd__nand2b_1 _538_ (.A_N(_209_),
    .B(_208_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_210_));
 sky130_fd_sc_hd__and2b_1 _539_ (.A_N(_208_),
    .B(_209_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_211_));
 sky130_fd_sc_hd__xnor2_1 _540_ (.A(_208_),
    .B(_209_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_212_));
 sky130_fd_sc_hd__xnor2_1 _541_ (.A(_203_),
    .B(_212_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_213_));
 sky130_fd_sc_hd__o32a_1 _542_ (.A1(_173_),
    .A2(_174_),
    .A3(_184_),
    .B1(_183_),
    .B2(_182_),
    ...
    .VPWR(VPWR),
    .X(_214_));
 sky130_fd_sc_hd__nand2b_1 _543_ (.A_N(_214_),
    .B(_213_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_215_));
 sky130_fd_sc_hd__xnor2_1 _544_ (.A(_213_),
    .B(_214_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_216_));
 sky130_fd_sc_hd__nand2_1 _545_ (.A(_196_),
    .B(_216_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _546_ (.A(_196_),
    ...
    .VPWR(VPWR),
    .Y(_218_));
 sky130_fd_sc_hd__and3_1 _547_ (.A(_187_),
    .B(_189_),
    .C(_218_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_219_));
 sky130_fd_sc_hd__a21oi_1 _548_ (.A1(_187_),
    .A2(_189_),
    .B1(_218_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_220_));
 sky130_fd_sc_hd__nor2_1 _549_ (.A(_219_),
    .B(_220_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_221_));
 sky130_fd_sc_hd__nor3b_1 _550_ (.A(_193_),
    .B(_165_),
    .C_N(_191_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_222_));
 sky130_fd_sc_hd__a21o_1 _551_ (.A1(_163_),
    .A2(_191_),
    .B1(_193_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_223_));
 sky130_fd_sc_hd__a21oi_1 _552_ (.A1(_166_),
    .A2(_222_),
    .B1(_223_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_224_));
 sky130_fd_sc_hd__xnor2_1 _553_ (.A(_221_),
    .B(_224_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\product_reg[10] ));
 sky130_fd_sc_hd__a31o_1 _554_ (.A1(net53),
    .A2(net35),
    .A3(_201_),
    .B1(_200_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_225_));
 sky130_fd_sc_hd__a22o_1 _555_ (.A1(net49),
    .A2(net38),
    .B1(net47),
    .B2(net39),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_226_));
 sky130_fd_sc_hd__and4_1 _556_ (.A(net39),
    .B(net49),
    .C(net38),
    .D(net46),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_227_));
 sky130_fd_sc_hd__inv_2 _557_ (.A(_227_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_228_));
 sky130_fd_sc_hd__nand2_1 _558_ (.A(_226_),
    .B(_228_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_229_));
 sky130_fd_sc_hd__a31o_1 _559_ (.A1(net50),
    .A2(net38),
    .A3(_205_),
    .B1(_204_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_230_));
 sky130_fd_sc_hd__nand2_1 _560_ (.A(net50),
    .B(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_231_));
 sky130_fd_sc_hd__and3_1 _561_ (.A(net50),
    .B(net36),
    .C(_230_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_232_));
 sky130_fd_sc_hd__xnor2_1 _562_ (.A(_230_),
    .B(_231_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_233_));
 sky130_fd_sc_hd__and2_1 _563_ (.A(\a_reg[4] ),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_234_));
 sky130_fd_sc_hd__nor2_1 _564_ (.A(_233_),
    .B(_234_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_235_));
 sky130_fd_sc_hd__and2_1 _565_ (.A(_233_),
    .B(_234_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_236_));
 sky130_fd_sc_hd__nor2_1 _566_ (.A(_235_),
    .B(_236_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_237_));
 sky130_fd_sc_hd__and3_1 _567_ (.A(_226_),
    .B(_228_),
    .C(_237_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_238_));
 sky130_fd_sc_hd__xnor2_1 _568_ (.A(_229_),
    .B(_237_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_239_));
 sky130_fd_sc_hd__o21ai_1 _569_ (.A1(_203_),
    .A2(_211_),
    .B1(_210_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_240_));
 sky130_fd_sc_hd__nand2_1 _570_ (.A(_239_),
    .B(_240_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_241_));
 sky130_fd_sc_hd__xor2_1 _571_ (.A(_239_),
    .B(_240_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_242_));
 sky130_fd_sc_hd__nand2_1 _572_ (.A(_225_),
    .B(_242_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_243_));
 sky130_fd_sc_hd__xnor2_1 _573_ (.A(_225_),
    .B(_242_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_244_));
 sky130_fd_sc_hd__a21oi_1 _574_ (.A1(_215_),
    .A2(_217_),
    .B1(_244_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_245_));
 sky130_fd_sc_hd__nand3_1 _575_ (.A(_215_),
    .B(_217_),
    .C(_244_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_246_));
 sky130_fd_sc_hd__nand2b_1 _576_ (.A_N(_245_),
    .B(_246_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_247_));
 sky130_fd_sc_hd__o21ba_1 _577_ (.A1(_219_),
    .A2(_224_),
    .B1_N(_220_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_248_));
 sky130_fd_sc_hd__xor2_1 _578_ (.A(_247_),
    .B(_248_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\product_reg[11] ));
 sky130_fd_sc_hd__nand2_1 _579_ (.A(net50),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_249_));
 sky130_fd_sc_hd__and2_1 _580_ (.A(net49),
    .B(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_250_));
 sky130_fd_sc_hd__nand2_1 _581_ (.A(net49),
    .B(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_251_));
 sky130_fd_sc_hd__mux2_1 _582_ (.A0(_251_),
    .A1(net36),
    .S(_227_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_252_));
 sky130_fd_sc_hd__xor2_1 _583_ (.A(_249_),
    .B(_252_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_253_));
 sky130_fd_sc_hd__and3_1 _584_ (.A(net38),
    .B(net46),
    .C(_253_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_254_));
 sky130_fd_sc_hd__a21oi_1 _585_ (.A1(net38),
    .A2(net47),
    .B1(_253_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_255_));
 sky130_fd_sc_hd__nor2_1 _586_ (.A(_254_),
    .B(_255_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_256_));
 sky130_fd_sc_hd__and2_1 _587_ (.A(_238_),
    .B(_256_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_257_));
 sky130_fd_sc_hd__xor2_1 _588_ (.A(_238_),
    .B(_256_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_258_));
 sky130_fd_sc_hd__o21a_1 _589_ (.A1(_232_),
    .A2(_236_),
    .B1(_258_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_259_));
 sky130_fd_sc_hd__nor3_1 _590_ (.A(_232_),
    .B(_236_),
    .C(_258_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_260_));
 sky130_fd_sc_hd__or2_1 _591_ (.A(_259_),
    .B(_260_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_261_));
 sky130_fd_sc_hd__a21o_1 _592_ (.A1(_241_),
    .A2(_243_),
    .B1(_261_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_262_));
 sky130_fd_sc_hd__inv_2 _593_ (.A(_262_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_263_));
 sky130_fd_sc_hd__nand3_1 _594_ (.A(_241_),
    .B(_243_),
    .C(_261_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_264_));
 sky130_fd_sc_hd__nand2_1 _595_ (.A(_262_),
    .B(_264_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_265_));
 sky130_fd_sc_hd__nand2b_1 _596_ (.A_N(_245_),
    .B(_219_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_266_));
 sky130_fd_sc_hd__a221o_1 _597_ (.A1(_163_),
    .A2(_191_),
    .B1(_220_),
    .B2(_246_),
    .C1(_193_),
    ...
    .VPWR(VPWR),
    .X(_267_));
 sky130_fd_sc_hd__a211o_1 _598_ (.A1(_166_),
    .A2(_222_),
    .B1(_245_),
    .C1(_267_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_268_));
 sky130_fd_sc_hd__and3_1 _599_ (.A(_246_),
    .B(_266_),
    .C(_268_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_269_));
 sky130_fd_sc_hd__and4b_1 _600_ (.A_N(_265_),
    .B(_266_),
    .C(_268_),
    .D(_246_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_270_));
 sky130_fd_sc_hd__xnor2_1 _601_ (.A(_265_),
    .B(_269_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\product_reg[12] ));
 sky130_fd_sc_hd__a22o_1 _602_ (.A1(net36),
    .A2(net46),
    .B1(net35),
    .B2(net49),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_271_));
 sky130_fd_sc_hd__nand3_1 _603_ (.A(net47),
    .B(net35),
    .C(_250_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_272_));
 sky130_fd_sc_hd__and3_1 _604_ (.A(_254_),
    .B(_271_),
    .C(_272_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _605_ (.A1(_271_),
    ...
    .VPWR(VPWR),
    .Y(_274_));
 sky130_fd_sc_hd__nor2_1 _606_ (.A(_273_),
    .B(_274_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_275_));
 sky130_fd_sc_hd__o2bb2a_1 _607_ (.A1_N(net36),
    .A2_N(_227_),
    .B1(_249_),
    .B2(_252_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_276_));
 sky130_fd_sc_hd__and2b_1 _608_ (.A_N(_276_),
    .B(_275_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_277_));
 sky130_fd_sc_hd__xnor2_1 _609_ (.A(_275_),
    .B(_276_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_278_));
 sky130_fd_sc_hd__nor3_1 _610_ (.A(_257_),
    .B(_259_),
    .C(_278_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_279_));
 sky130_fd_sc_hd__inv_2 _611_ (.A(_279_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_280_));
 sky130_fd_sc_hd__o21a_1 _612_ (.A1(_257_),
    .A2(_259_),
    .B1(_278_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_281_));
 sky130_fd_sc_hd__o22ai_1 _613_ (.A1(_263_),
    .A2(_270_),
    .B1(_279_),
    .B2(_281_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_282_));
 sky130_fd_sc_hd__or4_1 _614_ (.A(_263_),
    .B(_270_),
    .C(_279_),
    .D(_281_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_283_));
 sky130_fd_sc_hd__nand2_1 _615_ (.A(_282_),
    .B(_283_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\product_reg[13] ));
 sky130_fd_sc_hd__and3_1 _616_ (.A(net47),
    .B(net35),
    .C(_251_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_284_));
 sky130_fd_sc_hd__nor2_1 _617_ (.A(_273_),
    .B(_277_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_285_));
 sky130_fd_sc_hd__xnor2_1 _618_ (.A(_284_),
    .B(_285_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_286_));
 sky130_fd_sc_hd__or2_1 _619_ (.A(_263_),
    .B(_281_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_287_));
 sky130_fd_sc_hd__o21ai_1 _620_ (.A1(_270_),
    .A2(_287_),
    .B1(_280_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_288_));
 sky130_fd_sc_hd__o211a_1 _621_ (.A1(_270_),
    .A2(_287_),
    .B1(_286_),
    .C1(_280_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_289_));
 sky130_fd_sc_hd__xnor2_1 _622_ (.A(_286_),
    .B(_288_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\product_reg[14] ));
 sky130_fd_sc_hd__o311a_1 _623_ (.A1(_250_),
    .A2(_273_),
    .A3(_277_),
    .B1(net35),
    .C1(net47),
    ...
    .VPWR(VPWR),
    .X(_290_));
 sky130_fd_sc_hd__or2_1 _624_ (.A(_289_),
    .B(_290_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\product_reg[15] ));
 sky130_fd_sc_hd__a21oi_1 _625_ (.A1(_093_),
    .A2(_097_),
    .B1(_041_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_291_));
 sky130_fd_sc_hd__nor2_1 _626_ (.A(_098_),
    .B(_291_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\product_reg[5] ));
 sky130_fd_sc_hd__inv_2 _627_ (.A(net61),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_001_));
 sky130_fd_sc_hd__inv_2 _628_ (.A(net61),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_002_));
 sky130_fd_sc_hd__inv_2 _629_ (.A(net60),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_003_));
 sky130_fd_sc_hd__inv_2 _630_ (.A(net60),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_004_));
 sky130_fd_sc_hd__inv_2 _631_ (.A(net60),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_005_));
 sky130_fd_sc_hd__inv_2 _632_ (.A(net60),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_006_));
 sky130_fd_sc_hd__inv_2 _633_ (.A(net61),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_007_));
 sky130_fd_sc_hd__inv_2 _634_ (.A(net59),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_008_));
 sky130_fd_sc_hd__inv_2 _635_ (.A(net60),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_009_));
 sky130_fd_sc_hd__inv_2 _636_ (.A(net59),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_010_));
 sky130_fd_sc_hd__inv_2 _637_ (.A(net59),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_011_));
 sky130_fd_sc_hd__inv_2 _638_ (.A(net59),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_012_));
 sky130_fd_sc_hd__inv_2 _639_ (.A(net59),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_013_));
 sky130_fd_sc_hd__inv_2 _640_ (.A(net59),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_014_));
 sky130_fd_sc_hd__inv_2 _641_ (.A(net60),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_015_));
 sky130_fd_sc_hd__inv_2 _642_ (.A(net60),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_016_));
 sky130_fd_sc_hd__inv_2 _643_ (.A(net60),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_017_));
 sky130_fd_sc_hd__inv_2 _644_ (.A(net59),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_018_));
 sky130_fd_sc_hd__inv_2 _645_ (.A(net59),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_019_));
 sky130_fd_sc_hd__inv_2 _646_ (.A(net59),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_020_));
 sky130_fd_sc_hd__inv_2 _647_ (.A(net59),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_021_));
 sky130_fd_sc_hd__inv_2 _648_ (.A(net60),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_022_));
 sky130_fd_sc_hd__inv_2 _649_ (.A(net61),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_023_));
 sky130_fd_sc_hd__inv_2 _650_ (.A(net61),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_024_));
 sky130_fd_sc_hd__inv_2 _651_ (.A(net61),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_025_));
 sky130_fd_sc_hd__inv_2 _652_ (.A(net61),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_026_));
 sky130_fd_sc_hd__inv_2 _653_ (.A(net61),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_027_));
 sky130_fd_sc_hd__inv_2 _654_ (.A(net61),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_028_));
 sky130_fd_sc_hd__inv_2 _655_ (.A(net62),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_029_));
 sky130_fd_sc_hd__inv_2 _656_ (.A(net62),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_030_));
 sky130_fd_sc_hd__inv_2 _657_ (.A(net62),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_031_));
 sky130_fd_sc_hd__dfrtp_1 _658_ (.CLK(clknet_2_3__leaf_clk),
    .D(\product_reg[9] ),
    .RESET_B(_000_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net33));
 sky130_fd_sc_hd__dfrtp_1 _659_ (.CLK(clknet_2_3__leaf_clk),
    .D(\product_reg[10] ),
    .RESET_B(_001_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net19));
 sky130_fd_sc_hd__dfrtp_1 _660_ (.CLK(clknet_2_2__leaf_clk),
    .D(\product_reg[11] ),
    .RESET_B(_002_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net20));
 sky130_fd_sc_hd__dfrtp_1 _661_ (.CLK(clknet_2_2__leaf_clk),
    .D(\product_reg[12] ),
    .RESET_B(_003_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net21));
 sky130_fd_sc_hd__dfrtp_1 _662_ (.CLK(clknet_2_2__leaf_clk),
    .D(\product_reg[13] ),
    .RESET_B(_004_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net22));
 sky130_fd_sc_hd__dfrtp_1 _663_ (.CLK(clknet_2_2__leaf_clk),
    .D(\product_reg[14] ),
    .RESET_B(_005_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net23));
 sky130_fd_sc_hd__dfrtp_1 _664_ (.CLK(clknet_2_2__leaf_clk),
    .D(\product_reg[15] ),
    .RESET_B(_006_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net24));
 sky130_fd_sc_hd__dfrtp_1 _665_ (.CLK(clknet_2_2__leaf_clk),
    .D(net1),
    .RESET_B(_007_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _668_ (.CLK(clknet_2_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\a_reg[3] ));
 sky130_fd_sc_hd__dfrtp_1 _669_ (.CLK(clknet_2_0__leaf_clk),
    .D(net5),
    .RESET_B(_011_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\a_reg[4] ));
 sky130_fd_sc_hd__dfrtp_1 _670_ (.CLK(clknet_2_0__leaf_clk),
    .D(net6),
    .RESET_B(_012_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _674_ (.CLK(clknet_2_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\b_reg[1] ));
 sky130_fd_sc_hd__dfrtp_4 _675_ (.CLK(clknet_2_0__leaf_clk),
    .D(net11),
    .RESET_B(_017_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\b_reg[2] ));
 sky130_fd_sc_hd__dfrtp_1 _676_ (.CLK(clknet_2_0__leaf_clk),
    .D(net12),
    .RESET_B(_018_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\b_reg[3] ));
 sky130_fd_sc_hd__dfrtp_1 _677_ (.CLK(clknet_2_0__leaf_clk),
    .D(net13),
    .RESET_B(_019_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\b_reg[4] ));
 sky130_fd_sc_hd__dfrtp_1 _678_ (.CLK(clknet_2_0__leaf_clk),
    .D(net14),
    .RESET_B(_020_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _679_ (.CLK(clknet_2_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\b_reg[6] ));
 sky130_fd_sc_hd__dfrtp_1 _680_ (.CLK(clknet_2_2__leaf_clk),
    .D(net16),
    .RESET_B(_022_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\b_reg[7] ));
 sky130_fd_sc_hd__dfrtp_1 _681_ (.CLK(clknet_2_1__leaf_clk),
    .D(\product_reg[0] ),
    .RESET_B(_023_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net18));
 sky130_fd_sc_hd__dfrtp_1 _682_ (.CLK(clknet_2_1__leaf_clk),
    .D(\product_reg[1] ),
    .RESET_B(_024_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net25));
 sky130_fd_sc_hd__dfrtp_1 _683_ (.CLK(clknet_2_1__leaf_clk),
    .D(\product_reg[2] ),
    .RESET_B(_025_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net26));
 sky130_fd_sc_hd__dfrtp_1 _684_ (.CLK(clknet_2_1__leaf_clk),
    .D(\product_reg[3] ),
    .RESET_B(_026_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net27));
 sky130_fd_sc_hd__dfrtp_1 _685_ (.CLK(clknet_2_1__leaf_clk),
    .D(\product_reg[4] ),
    .RESET_B(_027_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__buf_2 output33 (.A(net33),
    ...
    .VPWR(VPWR),
    .X(product[9]));
 sky130_fd_sc_hd__clkbuf_1 max_cap34 (.A(_063_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net34));
 sky130_fd_sc_hd__buf_2 fanout35 (.A(\b_reg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net35));
 sky130_fd_sc_hd__clkbuf_2 fanout36 (.A(\b_reg[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net36));
 sky130_fd_sc_hd__clkbuf_2 fanout37 (.A(\b_reg[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net37));
 sky130_fd_sc_hd__buf_2 fanout38 (.A(\b_reg[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net38));
 sky130_fd_sc_hd__clkbuf_2 fanout39 (.A(\b_reg[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net39));
 sky130_fd_sc_hd__clkbuf_2 fanout40 (.A(\b_reg[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__clkbuf_2 fanout41 (.A(\b_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net41));
 sky130_fd_sc_hd__clkbuf_2 fanout42 (.A(\b_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net42));
 sky130_fd_sc_hd__buf_2 fanout43 (.A(\b_reg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net43));
 sky130_fd_sc_hd__dlymetal6s2s_1 fanout44 (.A(\b_reg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__buf_4 fanout45 (.A(\b_reg[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net45));
 sky130_fd_sc_hd__buf_2 fanout46 (.A(\a_reg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net46));
 sky130_fd_sc_hd__buf_1 fanout47 (.A(\a_reg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net47));
 sky130_fd_sc_hd__clkbuf_4 fanout48 (.A(\a_reg[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net48));
 sky130_fd_sc_hd__clkbuf_1 fanout49 (.A(\a_reg[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__clkbuf_4 fanout50 (.A(\a_reg[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net50));
 sky130_fd_sc_hd__buf_2 fanout51 (.A(\a_reg[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net51));
 sky130_fd_sc_hd__buf_2 fanout52 (.A(\a_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net52));
 sky130_fd_sc_hd__buf_1 fanout53 (.A(\a_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__clkbuf_2 fanout54 (.A(\a_reg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__buf_1 fanout55 (.A(\a_reg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__clkbuf_2 fanout56 (.A(\a_reg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__buf_1 fanout57 (.A(\a_reg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net57));
 sky130_fd_sc_hd__buf_2 fanout58 (.A(\a_reg[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkinv_4 clkload2 (.A(clknet_2_3__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__buf_1 rebuffer1 (.A(_063_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net63));
 sky130_fd_sc_hd__buf_1 rebuffer2 (.A(\a_reg[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net64));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer3 (.A(net64),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__fill_1 FILLER_0_111 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_8 FILLER_0_116 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__fill_2 FILLER_0_124 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_6 FILLER_0_129 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_5_6 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_5_32 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_fd_sc_hd__decap_4 FILLER_10_9 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_6 FILLER_10_16 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_15_18 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_fd_sc_hd__decap_8 FILLER_15_30 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_1 FILLER_17_30 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_8 FILLER_17_44 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_23_33 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_fd_sc_hd__decap_6 FILLER_23_45 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_4 FILLER_24_6 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_6 FILLER_24_13 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
